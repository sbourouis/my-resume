...
export const experiences: Experience[] = [
    ...
    },
    {
        ...
        type: EXPERIENCE_TYPE.SCHOOL,
        fromDate: new Date(2013, 9),
        toDate: new Date(2015, 8)
    },
    {
        id: 3,
        name: 'Development Engineer',
        location: 'IHU, Strasbourg, France',
        description: 'Web applications development using Angular 8, Unit tests, end-to-end tests writing, code review on both front and back-end, Dockerfile writing, Angular libraries development, CI pipeline set up…',
        type: EXPERIENCE_TYPE.WORK,
        fromDate: new Date(2018, 9),
        toDate: new Date(2019, 8)
    },
    {
        id: 4,
        name: 'R&D Developer Apprentice',
        location: 'IRCAD, Strasbourg, France',
        description: 'Full-stack web development using AngularJS, Angular and Node.js/NestJS, unit tests writing, member of a Scrum development team… ',
        type: EXPERIENCE_TYPE.WORK,
        fromDate: new Date(2015, 9),
        toDate: new Date(2018, 8)
    },
